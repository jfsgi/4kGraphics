...
> Product-vision documents for the full design-studio application this repository's
> rendering engine is building toward. The engine, demo UI, and render API implemented
> here (see the [repository README](../README.md)) form the rendering foundation for
> this product.
...
| Document | Contents |
|---|---|
| [01-product-vision.md](01-product-vision.md) | Vision, personas, product pillars, scope, phased roadmap |
| [02-user-workflow.md](02-user-workflow.md) | The end-to-end user workflow: Start → Build → Detail → Validate → Stage → Document → Share |
| [03-ui-design-standard.md](03-ui-design-standard.md) | **The UI design standard** all app UI must adhere to: principles, layout, tokens, components, viewport interaction, terminology |
| [04-architecture.md](04-architecture.md) | Technical architecture: frontend, geometry pipeline, render farm, data model |
| [05-component-standard.md](05-component-standard.md) | Authoring standard for parametric components: parameters, anchors, joinery, X/Y/Z scaling behavior |
